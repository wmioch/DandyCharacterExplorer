# Card scope review — September 22, 2026

Reviewed the 21 regular and two seasonal card names against the [wiki Cards table](https://dandys-world-robloxhorror.fandom.com/wiki/Cards), corroborated by the [cards guide](https://dandysworld.org/mechanics/cards). Check date September 22; source publication dates unavailable. Each named card below has an individual disposition.
...
| First Aid | Restore one missing Heart | Not a maximum-health modifier; no current-health simulation |
| Medical Attention | Restore one missing Heart | Same current-health limitation; not a maximum-health increase |
